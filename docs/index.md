...
<div>
<h2 v-if="!is_mirrored">Extra S</h2>
<h2 v-else>Extra Z</h2>
</div>  
...
<TDPC name="OUT OF ORDER TKI" v-bind="extra_S.OUTOFORDER" :mirror="is_mirrored" />
<TDPC name="TKI (HOLD S)" v-bind="extra_S.HOLDS" :mirror="is_mirrored" />
<TDPC name="TRUE TKI (HOLD L)" v-bind="extra_S.HOLDL" :mirror="is_mirrored" />
...
<h2 v-if="!is_mirrored">Extra J</h2>

<h2 v-else>Extra L</h2>

</div>

[train](https://jstris.jezevec10.com/play/mode/2592)

<TDPC name="T SPIN MINI" v-bind="extra_J.TSM" :mirror="is_mirrored" />
<TDPC name="DRAWBRIDGE" v-bind="extra_J.DRAWBRIDGE" :mirror="is_mirrored" />
